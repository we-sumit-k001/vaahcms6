<?php namespace VaahCms\Modules\Training\Http\Controllers\Backend;
...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-training';
        ...
        */
        ...
        return view('training::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            ...
            'version' => config('settings.global.training_version')??config('training.version'),
            'is_dev' => config('training.is_dev'),
        ];

...
let model_namespace = 'VaahCms\\Modules\\Training\\Models\\Practice';


let base_url = document.getElementsByTagName('base')[0].getAttribute("href");
let ajax_url = base_url + "/training/practices";
...
export const usePracticeStore = defineStore({
    ...
    actions: {
        ...
        async onLoad(route)
        {
             ...
             */
          const result=   this.updateQueryFromUrl(route);
            ...
            this.watch_stopper = watch(route, (newVal,oldVal) =>
                {
                    ...
                    console.log("wathcRoutes",this.route);
        ...
        async getAssets() {
            ...
            if(this.assets_is_fetching === true){
                ...
                const abc=await vaah().ajax(
                    this.ajax_url+'/assets',
                    this.afterGetAssets,
                );
                console.log("getAssestMethod",abc)
            }
        },
        //---------------------------------------------------------------------
        ...
        async getItemAfter(data, res)
        {
            if(data)
            {
                ...
                this.$router.push({name: 'practices.index'});
            }
        ...
        async updateUrlQueryString(query)
        {
            ...
            console.log("updateUrlquerystring  query-string",query_string);
            let query_object = qs.parse(query_string);

            console.log("updateUrlquerystring query-object",query_object);
        ...
        countFilters: function (query)
        {
            ...
            console.log("conuter fileter",this.count_filters);
        },
        //---------------------------------------------------------------------
        async clearSearch()
        {
        ...
        {
            //reset query strings
         const reset=   await this.resetQueryString();
        ...
        toForm()
        {
            this.item = vaah().clone(this.assets.empty_item);
            this.getFormMenu();
            this.$router.push({name: 'practices.form'})
        },
        //---------------------------------------------------------------------
        toView(item)
        {
            this.item = vaah().clone(item);
            this.$router.push({name: 'practices.view', params:{id:item.id}})
        },
        //---------------------------------------------------------------------
        toEdit(item)
        {
            this.item = item;
            this.$router.push({name: 'practices.form', params:{id:item.id}})
        },
        //---------------------------------------------------------------------
        isViewLarge()
        {

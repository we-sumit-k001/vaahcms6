                    ...
                    <div class="flex align-items-center justify-content-between">
                        ...
                        <div class="ml-3">
                            <Button label="Restore"
                                    class="p-button-sm"
                                    data-testid="tests-item-restore"
                ...
                <table class="p-datatable-table">
                    ...
                    <template v-for="(value, column) in store.item ">
                        ...
                        <template v-if=
                                      "column === 'created_by'     ||
                                       column === 'updated_by'     ||
                                       column === 'get_state_data' ||


                                     column === 'parent_id'  ||

                                       column === 'hw_taxonomies_type_id'||
                                       column === 'email'">
                        </template>
                        ...
                        <template v-else-if="column === 'get_state_data' || column === 'get_country_data' ">


                            <VhViewRow label="State"
                                       :value=store.item.get_state_data
                                       type="state"
                            />
                            <VhViewRow label="Country"
                                       :value=store.item.get_country_data
                                       type="country"
                            />

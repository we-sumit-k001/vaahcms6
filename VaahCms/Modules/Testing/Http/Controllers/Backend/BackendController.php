...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-testing';
        ...
        */
        ...
        return view('testing::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            ...
            'version' => config('settings.global.testing_version')??config('testing.version'),
            'is_dev' => config('testing.is_dev'),
        ];
